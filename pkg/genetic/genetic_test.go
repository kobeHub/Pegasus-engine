...
func TestGeneticAlgorithm(t *testing.T) {
	...
	pods := []models.Pod{
		models.NewPod("1-128", 1, 128, "", models.Unknown),
		models.NewPod("2-1024", 2, 1024, "", models.Unknown),
		models.NewPod("2-512", 2, 512, "", models.Unknown),
		models.NewPod("2-512", 2, 512, "", models.Unknown),
		models.NewPod("1-1024-1", 1, 1024, "", models.Unknown),
		models.NewPod("1-1024-2", 1, 1024, "", models.Unknown),
		models.NewPod("0.5-128-1", 0.5, 128, "", models.Unknown),
		models.NewPod("0.5-128-2", 0.5, 128, "", models.Unknown),
		models.NewPod("0.5-128-3", 0.5, 128, "", models.Unknown),
		models.NewPod("0.5-128-4", 0.5, 128, "", models.Unknown),
	}
	g := Genetic{
		AllNodes:           nodes,
		AllPods:            pods,
